...
public class Config {
    ...
    private final String stag_version;
    ...
    private Config(Context context) {
        ...
        stag_version = SystemProperties.get(
                res.getString(R.string.stag_version));

        property_device = SystemProperties.get(
                res.getString(R.string.property_device));

        filename_base = String.format(Locale.ENGLISH,
                res.getString(R.string.filename_base), stag_version);
